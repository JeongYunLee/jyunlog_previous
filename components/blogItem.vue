<template>
  <div>
    <article class="relative flex flex-col max-w-3xl lg:ml-auto xl:max-w-none xl:w-[50rem]">
      ...
      <h3 class="mb-2 text-2xl text-slate-700 tracking-tight font-bold dark:text-slate-200">
      ...
      <div class="mt-auto flex flex-row-reverse items-center justify-end">
        <dl>
          ...
          <dd
            ...
            <time class="bg-green-500 text-white py-1 px-2 rounded-md" datetime="2022-02-24T12:00:00.000Z">{{
